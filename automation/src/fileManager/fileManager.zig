...
pub const FileManager = struct {
    ...
    pub fn createFiles(self: *Self, chromeDriverOptions: DriverTypes.ChromeDriverConfigOptions) !void {
    ...
    fn createStartChromeDriverSh(self: *Self, fileName: []const u8, chromeDriverOptions: DriverTypes.ChromeDriverConfigOptions) !void {
        const cwd = Utils.getCWD();
